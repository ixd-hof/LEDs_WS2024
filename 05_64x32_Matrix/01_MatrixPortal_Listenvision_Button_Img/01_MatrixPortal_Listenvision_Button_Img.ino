...
void loop(void) {
  ...
  // change *1000 for speed adjustment
  x = map(sin(millis() / 1000.0) * 1000, -1000, 1000, -64, 0);
  Serial.println(x);

  // show image after button press
  if (buttonstate == 1)
    matrix.drawRGBBitmap(x, 0, farbverlauf1, 128, 32);
  else if (buttonstate == 2)
    matrix.drawRGBBitmap(x, 0, farbverlauf2, 128, 32);
